...
class Excel{
  constructor(){
    ...
    this.bookings = XLSX.utils.sheet_to_json(workbook.Sheets[workbook.SheetNames[0]]);
    this.sheet_name_list = workbook.SheetNames;
  }
...
module.exports.readAndSaveBookings = function (){
